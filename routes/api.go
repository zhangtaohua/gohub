...
import (
	controllers "github.com/zhangtaohua/gohub/app/http/controllers/api/v1"
	"github.com/zhangtaohua/gohub/app/http/controllers/api/v1/auth"
	"github.com/zhangtaohua/gohub/app/http/middlewares"
